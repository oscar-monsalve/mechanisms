# Grupo 10:
# Diseñar una leva con doble detenimiento con un tipo de programa de movimiento DRDF para mover un seguidor en 0 mm durante 90°, subida de 0 mm a 20 mm durante 90°, detenimiento en 20 mm durante 90°, y bajada de 20 mm en el resto del movimiento.
...
# np.savetxt("polinomio_3-4-5.txt", data_1, delimiter = ";", fmt = "%.6f")
...
# np.savetxt("polinomio_4-5-6-7.txt", data_2, delimiter = ";", fmt = "%.6f")
...
#PC-HOME
# image_path = "D:/OneDrive - Instituto Tecnológico Metropolitano/ITM/2. Teaching/2. Catedra/1. Mecanismos/Evaluación/6. Diseño_levas (20%)/Soluciones_ejercicios_levas/CAD_levas/Grupo_10.PNG"

#Ubuntu
image_path = "/home/om/personal/coding/mechanisms/cam_mechanism/CAD_levas/Grupo_10.PNG"
