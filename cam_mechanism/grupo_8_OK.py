# Grupo 8:
# Diseñar una leva con doble detenimiento con un tipo de programa de movimiento RDDF para mover un seguidor en subida de 0 mm a 15 mm durante 85°, detenimiento en 15 mm durante 170°, y bajada de 15 mm en el resto del movimiento.

import numpy as np
import matplotlib.pyplot as plt
import matplotlib.image as mpimg

# Definition of beta, theta in degrees and omega in rad/s
beta_1 = 85
beta_2 = beta_1 * 2
beta_3 = beta_1 * 3
beta_4 = 361 - beta_3
...
# HOME
image_path = "D:/OneDrive - Instituto Tecnológico Metropolitano/ITM/2. Teaching/2. Catedra/1. Mecanismos/Evaluación/6. Diseño_levas (20%)/Soluciones_ejercicios_levas/CAD_levas/Grupo_8.PNG"

# Lab
# image_path = "C:/Users/cadd.ITMROBLEDO/OneDrive - Instituto Tecnológico Metropolitano/ITM/2. Teaching/2. Catedra/1. Mecanismos/Evaluación/6. Diseño_levas (20%)/Soluciones_ejercicios_levas/CAD_levas/Grupo_8.PNG"

# LAPTOP windows
# image_path = "C:/Users/Oscar Monsalve/OneDrive - INSTITUTO TECNOLOGICO METROPOLITANO - ITM/ITM/2. Teaching/2. Catedra/1. Mecanismos/Evaluación/6. Diseño_levas (20%)/Soluciones_ejercicios_levas/CAD_levas/Grupo_8.PNG"

$# Ubuntu
image_path = "/home/om/personal/coding/mechanisms/cam_mechanism/CAD_levas/Grupo_8.PNG"
