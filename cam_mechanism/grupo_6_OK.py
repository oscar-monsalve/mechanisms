# Grupo 6:
# Diseñar una leva con doble detenimiento con un tipo de programa de movimiento RDFD para mover un seguidor en subida de 0 mm a 45 mm durante 70°, detenimiento en 45 mm durante 70°, bajada de 45 mm durante 70°, y detenimiento en 0 mm en el resto del movimiento.
...
beta_1 = 70 # Change for every exercise
beta_2 = beta_1 * 2
beta_3 = beta_1 * 3
beta_4 = 361 - beta_3
...
# np.savetxt("grupo_1_polinomio_3-4-5.txt", data_1, delimiter = ";", fmt = "%.6f")
...
# np.savetxt("grupo_1_polinomio_4-5-6-7.txt", data_2, delimiter = ";", fmt = "%.6f")
...
# HOME
image_path = "D:/OneDrive - Instituto Tecnológico Metropolitano/ITM/2. Teaching/2. Catedra/1. Mecanismos/Evaluación/6. Diseño_levas (20%)/Soluciones_ejercicios_levas/CAD_levas/Grupo_6.PNG"

# LAB
# image_path = "C:/Users/cadd.ITMROBLEDO/OneDrive - Instituto Tecnológico Metropolitano/ITM/2. Teaching/2. Catedra/1. Mecanismos/Evaluación/6. Diseño_levas (20%)/Soluciones_ejercicios_levas/CAD_levas/Grupo_6.PNG"

# LAPTOP windows
# image_path = "C:/Users/Oscar Monsalve/OneDrive - INSTITUTO TECNOLOGICO METROPOLITANO - ITM/ITM/2. Teaching/2. Catedra/1. Mecanismos/Evaluación/6. Diseño_levas (20%)/Soluciones_ejercicios_levas/CAD_levas/Grupo_6.PNG"

# Ubuntu
image_path = "/home/om/personal/coding/mechanisms/cam_mechanism/CAD_levas/Grupo_6.PNG"
